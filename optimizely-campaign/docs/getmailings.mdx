---
title: "getMailings"
description: "Queries sent mailings and the appropriate start and end time in Optimizely Campaign."
---
...
Sent mailings and the appropriate start and end time

**Code structure**

`String[][] getMailings(String sessionId, long since, long until, int startRow, int numberOfRows)
`