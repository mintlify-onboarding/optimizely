---
title: "getLinks"
description: "Queries the tracking links of sent mailings in Optimizely Campaign."
---
...
Tracking links of sent mailings

**Code structure**

`String[][] getLinks(String sessionId, long since, long until, int startRow, int numberOfRows)
`