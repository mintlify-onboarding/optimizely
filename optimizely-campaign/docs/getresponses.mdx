---
title: "getResponses"
description: "Query of all responses/returned emails: soft bounces, hard bounces, autoresponder and direct replies in Optimizely Campaign."
---
...
All recipients who have generated responses/returned emails, including the corresponding category.

**Code structure**

`String[][] getResponses(String sessionId, long since, long until, int startRow, int numberOfRows)
`