---
title: "getOpens"
description: "Queries recipients that opened a mailing and the time they opened the mailing in Optimizely Campaign."
---
...
Recipients that opened a mailing and the time they opened it

**Code structure**

`String[][] getOpens(String sessionId, long since, long until, int startRow, int numberOfRows)
`